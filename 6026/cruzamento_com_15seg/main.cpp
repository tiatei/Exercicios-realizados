...
const unsigned long redDuration = 5000;   // 3 segundos
const unsigned long yellowDuration = 5000; // 2 segundos
const unsigned long greenDuration = 5000;  // 3 segundos
const unsigned long verdepedestreDuration = 15000; // 10 segundos
...
void loop() {
  ...
  if (state == 0) {
    ...
    previousMillis = currentMillis;// Verifica se passou o tempo
    state = 1;
